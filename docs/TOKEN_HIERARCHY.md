...
### State Tokens Are Runtime/CSS Tokens

State tokens currently exist at runtime and in CSS export:
...
paths, but they are not yet fully modeled as a JSON `state` token group.
